...
(function (root) {
  ...
  const ON_AXIS = {
    money: {
      ...
      down: [
        ...
        { who: 'numbers', say: 'That\'s roughly one full coaching staff per athletic department, for anybody keeping track at home.' },
    ...
    autonomy: {
      up: [
        { who: 'wire', say: 'Conferences keep the call on this one. Four different leagues will now do four different things and we\'ll all pretend that is fine.' },
    ...
    cost: {
      up: [
        ...
        { who: 'tobacco', say: 'we\'re one bad TV cycle from losing our swim program and they keep writing rules like this' },
      ],
      down: [
    ...
    tradition: {
      up: [
        { who: 'porch', say: 'THE GAME IS BACK. I\'m not crying, the tailgate is windy.' },
      ...
      down: [
        ...
        { who: 'tv', say: 'You can\'t buy a rivalry. You can only cancel one. Ask anybody who used to be in the Big Eight.' },
    ...
    inventory: {
      up: [
        ...
        { who: 'wire', say: 'Networks are pleased. That isn\'t a small thing when the next negotiation starts in eighteen months.' },
      ],
      down: [
    ...
    labour: {
      ...
      down: [
        ...
        { who: 'wire', say: 'Expect a filing. There\'s always a filing.' },
      ],
    },
    exposure: {
      up: [
      ...
      down: [
        ...
        { who: 'column', say: 'A rule that won\'t end up in a deposition. Frame it.' },
      ],
    },
  };
  ...
  const ON_BLOC = {
    ...
    'Big Ten': {
      happy: [
        { who: 'midwest', say: 'parity achieved. we\'ll now argue about something else within the hour' },
        { who: 'midwest', say: 'presidents happy, ADs happy, my group chat cautiously not furious. big day' },
        { who: 'wire', say: 'The Big Ten got the number it went in asking for, which hasn\'t been true of every meeting this year.' },
      ],
      angry: [
    ...
    ACC: {
      happy: [
        { who: 'tobacco', say: 'a whole year where nothing got worse. we\'ll take it and we won\'t ask questions' },
        { who: 'tobacco', say: 'you can actually recruit against this. small mercies' },
        { who: 'wire', say: 'A rare good week for the ACC, which is a sentence this desk hasn\'t typed in a while.' },
      ],
      angry: [
        ...
        { who: 'wire', say: 'Two ACC schools took meetings about this before the vote. That isn\'t a rumor any more.' },
      ],
    },
    'Big 12': {
      happy: [
      ...
      angry: [
        { who: 'plains', say: 'we aren\'t the group of five and I\'m so tired of the sentence that puts us in it' },
        { who: 'plains', say: 'twelve wins and a conference title and we\'re still explaining ourselves in December' },
    ...
    'Group of Five': {
      happy: [
        ...
        { who: 'tv', say: 'That\'s a mid week November game with actual stakes on it. We\'ll take every one of those you can make.' },
    ...
    Networks: {
      happy: [
        { who: 'tv', say: 'That\'s a product. We can sell that on Monday morning and twice on Tuesday.' },
        { who: 'tv', say: 'Give us the window and we\'ll make it the biggest night of the fall.' },
      ...
      angry: [
        ...
        { who: 'wire', say: 'One rights holder has described the change internally as "a renegotiation event". That\'s a phrase with teeth.' },
      ],
    },
    Players: {
      happy: [
        { who: 'locker', say: 'somebody finally asked. that\'s the whole post' },
        { who: 'locker', say: 'guys who were putting their name in the portal in December are staying now. that\'s what this does' },
        { who: 'column', say: 'The players got something in writing. Thirty years of "we\'re looking into it" ended in an afternoon.' },
      ],
      angry: [
        { who: 'locker', say: 'we\'re students on a Tuesday and inventory on a Saturday and nobody in that room has to pick one' },
        { who: 'locker', say: 'add a game, add a week of hits, don\'t add a chair to the table. got it' },
    ...
    Presidents: {
      ...
      angry: [
        { who: 'wire', say: 'Two presidents have already asked their general counsel to put something in writing. That\'s how a vote starts.' },
        { who: 'column', say: 'You can run this sport past the coaches, the networks and the fans. You can\'t run it past a university lawyer.' },
      ],
    },
    Fans: {
      happy: [
      ...
      angry: [
        ...
        { who: 'porch', say: 'ninety dollars to park and they\'re still finding new ways to make it worse' },
        { who: 'porch', say: 'I have had these seats for thirty-one years and I\'m one more of these away from a Friday night high school game' },
  ...
  const ON_SEASON = {
    ...
    cinderella: [
      ...
      { who: 'column', say: 'A {seed} seed wins the thing and half the sport spends January explaining why that\'s bad, actually.' },
    ],
    chalk: [
      ...
      { who: 'numbers', say: 'Top seed wins it. That\'s the outcome the committee model predicts and it\'s the outcome nobody buys a ticket for.' },
    ],
    blowouts: [
      { who: 'tv', say: 'That first round wasn\'t a broadcast, it was a chore. We need to talk about the field.' },
    ...
    snub: [
      { who: 'wire', say: '{snub} finished {snubrecord} and didn\'t make the field. That\'s the loudest team in the country this week.' },
    ...
    grind: [
      { who: 'locker', say: 'that\'s four extra games for the guys who went the distance. somebody should count the bodies as well as the windows' },
    ...
    ratingsUp: [
      ...
      { who: 'numbers', say: '{per}M an average game, up on the year. That\'s the number the next deal gets written against.' },
    ],
    ratingsDown: [
      ...
      { who: 'numbers', say: '{per}M an average game. Down. There\'s a version of this sport that used to draw more with worse teams.' },
      { who: 'porch', say: 'turns out when you move everything to a stream nobody has, fewer people watch it. wild' },
    ],
    bigGame: [
      { who: 'tv', say: '{bigGame} drew {bigViewers} million on its own. That\'s the game the whole year gets remembered for.' },
      ...
      { who: 'porch', say: '{bigGame}. that\'s why we do this. that\'s the whole reason.' },
    ],
    autobids: [
  ...
  const ON_TERM = {
    removed: [
      ...
      { who: 'porch', say: 'well that was a term. genuinely couldn\'t tell you what the sport is now' },
    ],
    served: [
      ...
      { who: 'numbers', say: 'Rulings made, sport changed, room survived. That\'s the entire scorecard for this office.' },
    ],
  };
  ...
  const FILLER = {
    ...
    loud: [
      { who: 'column', say: 'Everybody in that room went home with something to be annoyed about. That\'s usually the sign of a real decision.' },
      ...
      { who: 'bagman', say: 'phone hasn\'t stopped. six different people, six different problems, none of them mine' },
      { who: 'porch', say: 'the group chat has gone completely feral and it\'s a Tuesday' },
      { who: 'numbers', say: 'That\'s one of the larger single beat swings this office has produced. Whether that is good depends on the chair.' },
      { who: 'tv', say: 'We\'re going to be talking about that one for a while, and not all of it kindly.' },
    ],
  };
