...
(function () {
  ...
  const VOICE = {
    SEC: {
      bands: [
        ['This is what we pay for.',
          ...
          'We\'ll be difficult about something else. Enjoy the afternoon.',
          'Put it in writing before somebody in this room reconsiders.',
          'Correct. Now don\'t revisit it in March when somebody complains.',
          'No notes. Write that down, it won\'t happen often.'],
        ['Fine. We\'ll take it.',
          'We can live with this. Don\'t read that as enthusiasm.',
          'Nobody here is thrilled. Nobody is calling a lawyer either.',
          'Acceptable. We have lost worse meetings than this one.',
          'We won\'t fight this one. We\'re saving it.',
          'It\'s a decision, and this office has made worse ones this month.'],
        ['We weren\'t consulted.',
          ...
          'We\'ll remember the process here longer than the decision.',
          'Somebody should have called first. Somebody always should have called first.',
          'Our presidents read about it in the paper. That\'s the part that stings.'],
        ['We have other options and everybody knows it.',
          ...
          'You\'re welcome to run the sport. You\'re running it without us.',
          'We\'re polling our members, and you won\'t enjoy the results.',
          'The next version of this conversation happens on our terms.'],
        ['We\'re done talking to this office.',
          'We\'ll schedule our own January. Thank you for your time.',
          'There\'s a version of this sport that doesn\'t have you in it. It\'s drawn up.',
          ...
          'There\'s a meeting this week that you aren\'t in.'],
      ],
      ...
      /* THE THIRD LOSS RUNNING. `grudge` in this file has always counted a streak and
         ...
         and an argument. */
      streak: [
        'That\'s three in a row and we have counted every one of them.',
      ...
      relief: [
        'Noted. It doesn\'t undo the last three meetings.',
        'A win for us, which after this year we are counting individually.',
        'Fine. Keep going and we\'ll stop drafting the other plan.',
        'We can put that in the win column. It\'s a short column this year.',
      ],
      grudge: [
        'We were with you until that.',
        'That\'s the first thing out of that office we have had to think about.',
        'Careful. We\'ve been patient and it isn\'t a renewable resource.',
        'We had been prepared to call this a good term. Had been.',
      ],
      on: {
        money: {
          good: ['Our number went up. Keep going.',
            'That\'s the first sensible thing to come out of that building all year.',
            'Good. Now do the same thing for the January windows.'],
          bad: ['That\'s our money and you just spent it on somebody else.',
            'You took it out of our pocket and called it fairness.',
            'We generate it. We would like to be in the room when it\'s divided.'],
        },
        autonomy: {
          good: ['Our house, our rules. That\'s all we ever asked.',
            'Good. We don\'t need a permission slip to schedule in November.'],
          bad: ['We don\'t need this office deciding what happens in Tuscaloosa.',
        ...
        cost: {
          good: ['Somebody else is paying for it. Excellent.',
            'A rule that costs us nothing. We didn\'t think you had it in you.'],
        ...
        inventory: {
          good: ['More games worth watching. We can sell that on Monday.',
            'Good. Give us the window and we\'ll fill it.'],
    ...
    'Big Ten': {
      bands: [
        ['Our presidents will be pleased, which is the hardest audience there is.',
          'That\'s parity. We\'ll say so publicly and mean it.',
          'Sensible. We won\'t make you regret agreeing with us.',
          ...
          'That\'s what a commissioner is for. We don\'t say it often.'],
        ['Workable.',
          'We\'ll take it back to the campuses and it will survive the room.',
          'Not what we asked for. Close enough to sign.',
          'It holds. It doesn\'t inspire anybody, and it holds.',
          'We have signed off on worse and called it a triumph.',
          'Our directors will grumble and vote for it anyway.'],
        ['That isn\'t parity and everybody in here can count.',
          'We\'re being asked to fund a system built for somebody else.',
          'We came out of that meeting further behind than we went in.',
          'The arithmetic in that room didn\'t include us.',
          'Somebody will ask us in January why we agreed to this. We didn\'t.'],
        ['We\'ll be looking at our own arrangements.',
          'There\'s a network that would take our inventory tomorrow. They have said so.',
          'Our schools didn\'t join a conference to be the second call.',
        ...
        ['This office no longer speaks for us.',
          'We\'ll announce our own postseason and you\'ll read about it.',
          'Eighteen presidents, one vote, and it isn\'t going your way.',
          'We aren\'t attending the next one. Send the minutes.',
          'Our presidents have voted and the vote wasn\'t close.',
          'You\'ll find out what we are doing when everybody else does.'],
      ],
      /* THE TWO THINGS A ROOM SAYS THAT A MOOD BAND CANNOT. `relief` is an unhappy bloc
         acknowledging a win without forgiving anything; `grudge` is a content one being
         let down. Without them a bloc sitting at forty printed an angry sentence beside a
      ...
      streak: [
        ...
        'Every meeting this year has gone the same way and it isn\'t the way we came in asking for.',
        'There\'s a version of this where we stop attending.',
      ],
      relief: [
        'Better. Our presidents will want to see two more like it.',
        'That helps. It doesn\'t settle anything.',
        'One meeting in the right direction. We have a long memory for the other kind.',
        'That\'s closer to what we asked for than anything else this year.',
      ],
      grudge: [
        ...
        'We came in supportive. You\'re spending that down quickly.',
      ],
      on: {
        money: {
          good: ['That\'s a number our presidents can defend at a board meeting.',
            'Fair split. We won\'t pretend to be unhappy about it.'],
          bad: ['We\'re the largest footprint in the sport and we just got the smaller half.',
            'Somebody has to explain that number to eighteen boards. It won\'t be us.'],
        },
        autonomy: {
          good: ['Our conference, our calendar. Good.',
            'We can live with any rule we wrote ourselves.'],
          bad: ['We didn\'t vote to hand this office our scheduling.',
            'Every campus lawyer in this conference just opened a new file.'],
        },
        inventory: {
          good: ['More primetime. Our partners will be delighted.',
            'That\'s a noon window, a late window and a night game. Good work.'],
          bad: ['You just deleted a television window we already sold.',
            'Fewer games is fewer rights fees. That math doesn\'t move.'],
        },
        exposure: {
          good: ['Cleaner than what we had. Our counsel is nodding.',
            'That one won\'t end up in front of a judge. Rare.'],
          bad: ['We have general counsel on this call and she isn\'t happy.',
            'Our presidents don\'t do depositions. That\'s the whole rule.'],
        },
      },
    },
    ...
    ACC: {
      bands: [
        ['That buys us time, and time is the only thing we were short of.',
          ...
          'We\'ll take a year with no emergency calls. Thank you.'],
        ['We can live with it.',
          'It isn\'t a fix. It isn\'t a funeral either.',
          'We\'ll take a year where nothing gets worse.',
          'Nothing broke today. In this conference that counts.',
          'It buys a season. We\'ll spend it well.',
          'We would have asked for more. We didn\'t expect to get this.'],
        ['Our members will read this as a reason to leave.',
          ...
          'That\'s one more reason to leave, and we\'re short of reasons to stay.',
          'We\'ll spend the spring explaining this to nine athletic directors.'],
        ['Our lawyers are already reading it. So are theirs.',
          ...
          'We\'re one bad ruling from being a map with holes in it.'],
        ['There may not be an ACC to consult next year.',
          ...
          'There\'s a version of next year with six of us in it.',
      ...
      /* THE THIRD LOSS RUNNING. `grudge` in this file has always counted a streak and
         ...
         and an argument. */
      streak: [
        'Every one of these lands on us and there aren\'t many of us left.',
        'Three in a row. Two of our schools have stopped pretending they are staying.',
        'We came into this term hanging on. You haven\'t helped once.',
      ],
      relief: [
        'We\'ll take it. We aren\'t in a position to be proud about it.',
        'That\'s a lifeline, and we\'re aware of what a lifeline is.',
      ...
      grudge: [
        ...
        'That\'s a phone call two of our schools are going to make tonight.',
        'We were nearly comfortable. Nearly.',
        'That\'s the one thing we couldn\'t afford this week.',
      ],
      on: {
        money: {
        ...
        access: {
          ...
          bad: ['Narrow it further and our best season stops meaning anything.',
            'You just told our members that winning this conference isn\'t enough.'],
        },
        cost: {
          good: ['Our members can afford that, which isn\'t nothing these days.',
            'A rule that doesn\'t cost us anything is a rule we can pass.'],
        ...
        tradition: {
          ...
          bad: ['You just spent a hundred years of somebody\'s November.',
            'Our fans don\'t travel for an efficiency. They travel for the old things.'],
        },
      },
    },
    ...
    'Big 12': {
      bands: [
        ['A seat at last.',
          'That\'s the first time this conference has been treated as a peer. We noticed.',
          'Good. Now say the same thing in public with a camera on.',
          'For once we\'re in the sentence rather than the footnote.',
          'That\'s the ruling we have been asking three commissioners for.',
          'We\'ll hold you to it, and we\'ll thank you in public first.'],
        ['Acceptable.',
          'We\'ll take it, and we\'ll still be asking for more in the spring.',
          'Not a win. Not the usual.',
          'More than the usual, which isn\'t the same as enough.',
          'We can sell that to our schools without a long meeting.',
          'Nothing to celebrate. Nothing to appeal either.'],
        ['We\'re being lumped in again.',
          'We aren\'t the Group of Five and we\'re tired of the sentence that says we are.',
          'Somebody drew a line and put us on the wrong side of it. Again.',
          'We\'re a power conference on the letterhead and nowhere else today.',
          'Every one of these costs us a recruit we will never hear about.',
          'The fourth share of everything, forever, isn\'t a business.'],
        ['We\'ll look after ourselves.',
          'This conference has been written off twice and is still here. Try a third time.',
          'We have expansion targets and a phone. Don\'t make us use both.',
          'We\'ve been left for dead before and we\'re still scheduling games.',
          'There are four schools in other leagues who take our calls now.',
          'You\'re pricing us out and calling it a formula.'],
        ['We aren\'t participating in this.',
          'You can hold the meeting. We\'ll read the minutes.',
          'The last office that treated us like this doesn\'t exist any more.',
          'We\'ll make our own arrangements and announce them on our own day.',
          'This conference has outlived two of these offices already.',
          'Don\'t send us the agenda. We aren\'t coming.'],
      ],
      /* THE TWO THINGS A ROOM SAYS THAT A MOOD BAND CANNOT. `relief` is an unhappy bloc
         acknowledging a win without forgiving anything; `grudge` is a content one being
         let down. Without them a bloc sitting at forty printed an angry sentence beside a
      ...
      /* THE THIRD LOSS RUNNING. `grudge` in this file has always counted a streak and
         ...
         and an argument. */
      streak: [
        'Third time. We\'re starting to think it\'s deliberate.',
        'Nobody in this league expects anything from that office any more.',
        'We\'ve been on the wrong end of every ruling this year. Every single one.',
      ],
      relief: [
        'Better than the usual. We aren\'t sending a thank you card.',
        'Progress, from a very low base, and we know exactly how low.',
        'Something went our way for once. We\'ll believe it in November.',
        'That\'s the sort of thing we joined this league expecting.',
      ],
      grudge: [
        'We were on your side this morning.',
        'That\'s a step backwards and we didn\'t have many to spare.',
        'Don\'t do that again. We\'ve been very reasonable.',
      ...
      on: {
        money: {
          ...
          bad: ['We\'re already the fourth number on that page. You made it smaller.',
            'That\'s a coordinator we can\'t afford now. Multiply it by sixteen.'],
        },
        access: {
          good: ['Our champion gets in. That\'s the whole ballgame for us.',
        ...
        cost: {
          ...
          bad: ['Our budgets aren\'t their budgets and this rule was written for theirs.',
            'The two biggest leagues will pay that out of petty cash. We won\'t.'],
        },
        autonomy: {
          good: ['We\'ll handle our own house, thank you.',
    ...
    'Group of Five': {
      bands: [
        ['A real path. Finally.',
          ...
          'We\'ll tell sixty athletic directors tonight and none of them will sleep.',
          'That\'s the difference between a sport and a closed shop. You chose right.'],
        ['Better than nothing.',
          'We\'ll take the crumb. We would like it noted that it is a crumb.',
          'It\'s progress. Slow, but the arrow is the right way.',
          'We\'ll take it and keep asking. That has always been the job.',
          'It isn\'t the door. It\'s a crack, and we have gone through smaller.',
        ...
        ['We\'re filing.',
          'There\'s an antitrust lawyer in this conference who has been waiting years for this.',
          ...
          'We\'re documenting all of this. Somebody will want it eventually.'],
        ['We\'ll see you in front of a judge.',
          'Congress has asked us to come and explain the sport. We\'re going to.',
          'Sixty schools, one exhibit, and your name on the front of it.',
          'We aren\'t scheduling your buy games any more. Find somebody else.',
          'There\'s a subcommittee that would love to hear about today.',
      ...
      streak: [
        ...
        'There\'s a filing cabinet in this conference with your name on the folder.',
        'We stopped hoping about two meetings ago.',
      ],
      relief: [
        'We\'ll take it and we\'ll still be in front of a judge about the rest.',
      ...
      grudge: [
        ...
        'That\'s the part where it always goes wrong for us.',
        'We had hope for about a season. That\'s longer than usual.',
        'For a moment there we were being treated as part of the sport.',
      ],
      on: {
        access: {
          good: ['One guaranteed bid. That\'s all we ever asked for and you gave it.',
            'An undefeated season now leads somewhere. That\'s a different sport for us.'],
          bad: ['Undefeated and outside again. There\'s no way to coach around that.',
        ...
        money: {
          ...
          bad: ['They\'re arguing over the eighth slice. We\'re asking to see the pie.',
        ...
        cost: {
          good: ['Something we can actually pay for. Write more of those.',
            'A rule that doesn\'t price us out. That\'s new.'],
        ...
        tradition: {
          ...
          bad: ['Our traditions apparently don\'t make the list.',
            'A Tuesday night in November isn\'t a tradition, it\'s what you left us.'],
        },
      },
    },
    ...
    Networks: {
      bands: [
        ['That\'s a product we can sell.',
          'Our sales team just stopped worrying about the fourth quarter of the year.',
          'That\'s three hours we can charge premium for. Thank you.',
          'Our affiliates will run that promo unpaid. That\'s how good it is.',
          'You just created a night. Nobody in this sport creates nights.'],
        ['We can work with it. That isn\'t praise.',
          'It isn\'t what we would have drawn up. It\'s sellable.',
          'We\'ll make it work. We always do, and it always costs somebody something.',
          'It\'s sellable. It isn\'t the pitch we wanted to make.',
        ...
        ['This devalues the inventory.',
          ...
          'We\'re the only people in this building who have to make a number.'],
        ['The next deal will reflect this.',
          'Every one of these decisions shows up in the number at renewal.',
          'We aren\'t paying premium money for a Saturday you have hollowed out.',
          'The renewal conversation will be shorter and colder than the last one.',
          'There\'s a number in our model for this and it\'s going down.',
          'We\'re already looking at what else we could put on instead.'],
        ['We aren\'t bidding on that.',
          'Take it to somebody else and see what they say. We\'ll wait.',
          'You can have the sport you want or the check. Not both.',
          'We\'ll let the rights lapse and see who else turns up.',
      ...
      /* THE THIRD LOSS RUNNING. `grudge` in this file has always counted a streak and
         ...
         and an argument. */
      streak: [
        'Three decisions in a row that made the product worse. We\'re keeping a note.',
        'Every one of these costs us something. They add up before the renewal does.',
        'We\'re going to have a very short conversation about the next deal.',
      ],
      relief: [
        'That helps the number. It doesn\'t fix the number.',
        'Sellable. We\'ll still be having a difficult conversation at renewal.',
        'Good for one Saturday. We buy the whole fall.',
        'That\'s one Saturday improved. There are thirteen of them.',
      ],
      grudge: [
        'We were happy. Please understand how rare that is.',
        'That comes out of something we had already sold. It shows up later.',
        'One of those is fine. We\'re going to count them.',
        'We had this season priced. It\'s worth less than it was this morning.',
      ],
      on: {
        inventory: {
          good: ['More games that matter in more windows. That\'s the entire business.',
            'That\'s three additional nights we can put a number on.',
            'Give us that window and we\'ll make it the biggest night of the fall.'],
          bad: ['You just deleted inventory we had already sold to advertisers.',
            'Fewer meaningful games is a smaller check. It isn\'t complicated.',
            'You have taken a game people would have watched and made it a formality.',
            'Half of that slate is now a rating we can\'t sell against.',
        ...
        exposure: {
          ...
          bad: ['We don\'t want to be broadcasting a lawsuit in progress.',
            'Advertisers ask about that sort of thing now. They didn\'t use to.'],
        },
        tradition: {
          good: ['That\'s a ratings event and always has been. Protect it.',
    ...
    Players: {
      bands: [
        ['Somebody finally listened.',
          'That\'s the first rule in a while that was written with us in the room.',
          ...
          'We\'ve been asking for exactly that since before most of us got here.'],
        ['It\'s a start.',
          'We\'ll take it. We aren\'t going to pretend it is finished.',
          'Better than last year, which is a low bar and still a bar.',
          'We\'ll take it. We\'re still counting the things it doesn\'t fix.',
          'It helps the guys after us more than it helps us. That\'s fine.',
          'Nobody is celebrating. Nobody is walking out either.'],
        ['We\'re being talked about, not to.',
        ...
        ['We\'re organizing.',
          ...
          'We\'re the only ones in this sport who can\'t say no to anything.',
          'The room decided. The room doesn\'t play on Saturday.'],
        ['We\'ll bargain, or we\'ll sit.',
          'Ask yourself what a championship weekend looks like with nobody on the field.',
          'You don\'t have a sport without us. That has always been true.',
          'There\'s a group chat with four thousand players in it and it\'s angry.',
          'You\'ll find out what a walkout looks like in November.',
      ...
      /* THE THIRD LOSS RUNNING. `grudge` in this file has always counted a streak and
         ...
         and an argument. */
      streak: [
        'Third one. We aren\'t asking any more, we\'re organizing.',
        'Every ruling this year has been about us and none of them has been with us.',
        'There\'s a lawyer on this call now. There didn\'t use to be.',
      ],
      relief: [
        'That\'s one thing. There\'s a list.',
        'We noticed. It doesn\'t change that we aren\'t in the room.',
        'Something, finally, and about a decade after it should have been obvious.',
        'We\'ll take the win. We would rather have had the meeting.',
      ],
      grudge: [
        'We were listening. That\'s the part that stings.',
      ...
      on: {
        labour: {
          good: ['That\'s money and time that actually reaches a locker room.',
            'A real share, in writing. That\'s what we came for.',
          ...
          bad: ['You want the revenue of a professional league and the labor costs of a club team.',
            'We\'re the only people in that room who aren\'t paid to be in it.',
        ...
        inventory: {
          good: ['More exposure, if you\'re one of the guys who gets it.',
    ...
    Presidents: {
      bands: [
        ['Defensible. That matters more than anybody in this room admits.',
          ...
          'Our counsel read it twice and had nothing to add. That\'s a first.',
          'We can defend that to a board without a rehearsal.'],
        ['We can explain this.',
          'It will survive a trustees meeting. Not comfortably, but it will survive.',
          'We would have written it differently. We won\'t fight it.',
          'It will pass a committee. Slowly, and it will pass.',
          'We can live inside that. Our budgets can\'t live inside much.',
        ...
        ['This ends up in a courtroom.',
          ...
          'You have created a fact pattern. That\'s what they call it afterwards.',
          'The football team is eight percent of this campus and a hundred percent of the risk.',
          'We\'ll be answering questions about that ruling under oath eventually.',
        ...
        ['A vote is being scheduled.',
          ...
          'Two of us have been asked to testify. We\'re going to be honest.',
      ...
      on: {
        ...
        cost: {
          good: ['A number our budgets can carry. That\'s the rarest thing you can hand us.',
            'We can fund that without touching the academic side. Barely.'],
          bad: ['That comes out of a university budget, and universities aren\'t football teams.',
        ...
        money: {
          good: ['Revenue we can point at when the faculty asks what this is for.',
            'That helps. Institutions aren\'t flush.'],
          bad: ['The revenue goes down and the obligations don\'t. We have seen this film.'],
        },
        autonomy: {
          ...
          bad: ['You have taken a decision that belongs to the institutions.',
            'Our charters don\'t have a commissioner in them.'],
        },
      },
    },
    ...
    Fans: {
      bands: [
        ...
        ['We\'ll get used to it.',
          'It isn\'t the end of the world. It isn\'t why we started watching either.',
          'Fine. We complained about the last one too and here we still are.',
          'It\'s fine. We say that every year and we\'re always still here.',
          'Not what we wanted. Not worth the argument either.',
          'We\'ll grumble in September and forget about it by October.'],
        ...
        ['You\'re ruining it.',
          'My grandfather sat in that stadium. He wouldn\'t recognize the schedule.',
          'Half the reason we watched is gone and they\'re calling it growth.',
          'The season we grew up with is a thing you have to explain to a child.',
          'We\'re the only ones in this who never get a vote.'],
        ['We\'ll find something else on.',
          'Enjoy the sport. We\'ll be at a high school game on Friday.',
          'You finally did it. The tickets are for sale and nobody is buying.',
          'We\'re done. Not angry, just done.',
          'There\'s a high school field three miles away with real people in it.',
      ...
      streak: [
        ...
        'We\'ve been saying the same thing all year and it\'s going very well.',
      ],
      relief: [
        'Credit where it is due. We\'re still angry about the kickoff times.',
        'Fine, that one was good. Don\'t let it go to your head.',
        'One good decision. We\'ve been counting the other kind since 2010.',
        'That one was for us. We aren\'t going to pretend it wasn\'t.',
      ],
      grudge: [
        ...
        'We were enjoying this. That\'s the last time we do that.',
      ],
      on: {
        tradition: {
          good: ['That game is back. That\'s all anybody wanted.',
            'The rivalry survives, the band plays, the world keeps turning.',
            'Somebody in that room has actually been to a game. Thank you.'],
          bad: ['That\'s a hundred years old and you spent it for a television deal.',
            'They will put something cheaper in its place and call it a solution.',
            'You can\'t buy these things back once you have spent them. Ask the Big Eight.',
        ...
        access: {
          good: ['More teams alive in November is more reasons to care in September.',
            'Our school actually has a road in now. That\'s the whole point.'],
        ...
        labour: {
          good: ['Pay them. They\'re why we\'re there.',
        ...
        inventory: {
          good: ['More football is more football. We\'re simple people.',
            'Give us the noon game and the night game and we\'ll be there for both.'],
    ...
    Union: {
      bands: [
        ['Our members will hear about this from us, and it will be good news.',
          'That\'s what bargaining is for. Nobody had to be sued.',
          'We\'ll take the win and we won\'t pretend it was your idea.',
          'Write it into the agreement and it\'s done.',
          'Somebody in there has actually read the last four grievances.',
          'That\'s the first time this office has moved before a filing date.'],
        ['We can work with it. We aren\'t signing anything today.',
          'Acceptable. It isn\'t the thing we asked for.',
          'Our lawyers say take it. Our members are going to ask why it took four years.',
          'Fine. The next one is the one that matters.',
          'We\'ll put it to a vote and we won\'t campaign against it.',
          'It\'s progress and it\'s the smallest amount of progress available.'],
        ['You did that without calling us, which is the part we will remember.',
          'Every one of these lands on a twenty year old who can\'t vote on it.',
          'We\'re a party to this. You keep treating us as an audience.',
          'That\'s a decision about our members, made in a room they aren\'t in.',
          'File it. We\'ll be reading it very carefully.',
        ...
        ['We have a strike fund and this is the sort of thing it is for.',
          'Our members are asking what the union is for. You\'re helping us answer.',
          'There\'s a version of September where nobody takes the field.',
          'We\'ll see you in front of the board.',
          'You\'re bargaining in bad faith and we have started writing that down.',
          'Every player in this sport now knows your name. That isn\'t a compliment.'],
        ['We\'re done talking. Talk to the lawyers.',
          'The next thing you hear from us will be filed, not said.',
          'There\'s no version of this where we come back to that table.',
      ...
      streak: ['Three of these in a row. Our members are counting too.',
        'That\'s the third. There\'s a pattern and we have named it in writing.',
        'Three straight. Nobody in our membership believes this office negotiates.'],
      relief: ['That helps. It doesn\'t undo the last one.',
        'We\'ll take that as a gesture and treat it as one.',
        'Better. Our members will still ask what changed.',
        'That softens it. It doesn\'t settle it.'],
      ...
      on: {
        labour: {
          good: ['That\'s money in the pocket of somebody who earns it on a Saturday.',
            'Our members will feel that one in a way they can describe.'],
          bad: ['You have taken something off people who can\'t vote on it.',
            'That\'s a pay cut written in a language designed to hide it.',
            'Every dollar of that came out of a nineteen year old.'],
        },
        inventory: {
          good: ['Fewer games is fewer bodies. We\'ve been asking for four years.',
            'That\'s a workload decision and it\'s the right one.'],
          bad: ['More games, same people. You\'re spending them.',
            'Somebody has to play all of that, and it isn\'t anybody in that room.'],
        },
        autonomy: {
          good: ['A rule we get a say in is a rule that holds.',
            'You shared the pen. That\'s worth more than the clause.'],
          bad: ['That\'s you deciding alone about people who aren\'t you.',
    ...
    Capital: {
      bands: [
        ['That\'s a return. Everything else in this sport is sentiment.',
          ...
          'That\'s the first decision here that would survive a board meeting.',
          'Good. Now protect it from the people who want it undone.',
          'We\'re revising the model upward. That\'s the highest thing we say.'],
        ['Workable. The margin is thinner than we modelled.',
          'We can live with it. We wouldn\'t have chosen it.',
          'That\'s neutral, and neutral is a cost at our cost of capital.',
          'Acceptable. Our patience is priced and it isn\'t free.',
          'Nobody on our side is upset. Nobody is impressed.',
          'It holds. We\'ll want the next one to do more than hold.'],
        ['That\'s value destroyed for a reason nobody wrote down.',
          'We weren\'t consulted on a decision that moves our position.',
          'You have made this harder to sell, which wasn\'t yours to do.',
          'Every quarter like that one is a conversation we have to have upstairs.',
          'That\'s sentiment with a price tag, and we\'re paying it.',
          'We aren\'t a fan of the sport. We\'re an owner of it. Act accordingly.'],
        ['Our committee has begun asking what the exit looks like.',
          'There\'s a number at which we stop being patient and we\'re near it.',
          'We\'ve been in worse assets. We left those too.',
          'The next call you take about this won\'t be from us.',
          'You\'re governing this like it is still a non-profit. It hasn\'t been for years.',
          'We\'re writing this position down and the pen is moving the wrong way.'],
        ['We\'re out, and we\'ll be loud about why.',
          ...
          'We\'ll recover this in a courtroom and it will be public.',
          'Whatever this sport is next, we won\'t be funding it.'],
      ],
      streak: ['Three in a row against the position. That\'s a trend, not a run of luck.',
      ...
      relief: ['That recovers some of it. Some.',
        ...
        'That stops the bleeding. It doesn\'t repair the quarter.'],
      grudge: ['We had marked that as settled. It isn\'t.',
      ...
      on: {
        money: {
          good: ['That\'s revenue that compounds. Everything else is a press release.',
            'The number moves. That\'s the only sentence we came here to say.'],
          bad: ['You have given away margin to buy affection.',
            'That\'s money out of the stadium and into a feeling.'],
        },
        tradition: {
          ...
          bad: ['Nostalgia isn\'t a business model and you keep running one.',
            'You\'re paying a premium for a marching band nobody under thirty watches.'],
        },
        cost: {
    ...
    Congress: {
      bands: [
        ['That\'s what we asked for, and we\'ll say so on the record.',
          'The committee is satisfied. For now, and in public.',
          'You moved before we made you. Members notice that.',
          'Good. We\'ll find something else to hold a hearing about.',
        ...
        ['Noted. The committee has no further questions today.',
          'That\'s adequate and adequate keeps you off the calendar.',
          'We\'ll take it back to the members. Nobody will be excited.',
          'It doesn\'t fix the thing, and it isn\'t nothing.',
          'Fine. The bill stays in the drawer.',
          'We aren\'t satisfied. We\'re also not scheduling anything.'],
        ['You did that without telling anybody up here.',
          'That\'s going to be read out in a hearing room and you\'ll be in it.',
          'A private association making public policy. That\'s our whole concern, restated.',
          'Three members already want a letter. There will be a letter.',
          'This is the part where you find out what oversight means.',
          'There\'s a campus in somebody\'s district that cares, so now somebody up here does.'],
        ['We have the votes to compel you and we have begun counting them.',
          'You\'ll answer for that under oath.',
          'There\'s a bill with your office named in it. It has co-sponsors now.',
          'You\'re a hearing away from not making these decisions any more.',
          'Every member on this committee has now been contacted about you.',
          'We can legislate. We\'ve been polite about not doing it.'],
        ['The bill is filed. You\'ll be reading about your office in it.',
          'This committee no longer accepts that you should exist in this form.',
          'We\'re done asking. The next document you get isn\'t a letter.',
          'You have made the case for us better than we could.',
          'Whatever this sport is governed by next, it won\'t be you.',
          'We\'ll see you in that room, and this time you won\'t be a guest.'],
      ],
      streak: ['Three in a row. That isn\'t an oversight, that\'s a posture.',
      ...
      relief: ['That takes some of the heat out of it. Some.',
        ...
        'That narrows it. It doesn\'t close it.'],
      grudge: ['We had let that go. You have reminded us.',
        ...
        'We closed that inquiry. It\'s open again and it\'s broader.'],
      on: {
        exposure: {
          good: ['That\'s one less thing we have to explain to a constituent.',
            'You closed a door before somebody up here kicked it in. Noted.'],
          bad: ['That\'s a hearing. Not a risk of one, a hearing.',
        ...
        autonomy: {
          good: ['A decision with somebody else in the room is a decision we can defend.',
            'You brought people in. That\'s the entire ask.'],
        ...
        labour: {
          good: ['That\'s a kid on a scholarship better off. It\'s an easy thing to support.',
            'We can read that out at home and people will nod.'],
          bad: ['We\'ll be asked why we let that happen to somebody\'s kid.',
    ...
    'White House': {
      bands: [
        ['The President is pleased, and the President will say so somewhere visible.',
          'That polls. We don\'t say that about many decisions.',
          'We would like to be standing near that when it happens.',
          'Good instinct. It reads the way the country already feels.',
          'That\'s the sort of thing that gets mentioned from a podium.',
          'The building likes it. The building doesn\'t like much.'],
        ['Fine. Nobody here will be commenting either way.',
          'We can live with it. It doesn\'t help us and it doesn\'t hurt.',
          'Understood. It won\'t come up.',
          'That\'s a sport decision and we\'ll treat it as one.',
          'No objection. No enthusiasm either.',
          'We have looked at it and we have nothing to add.'],
        ['That\'s going to be raised at a briefing and we would rather it weren\'t.',
          'You have made a domestic story out of a football decision.',
          'The President will be asked about that and won\'t enjoy it.',
          ...
          'That\'s the kind of thing that ends up in a speech somebody else writes.'],
        ['The President has views about this office now, and they aren\'t warm.',
          'We can make this a priority. You wouldn\'t enjoy being a priority.',
          'There are people in this building who would like to legislate you.',
          'You\'re one bad Saturday from being an agenda item.',
          'We\'ve been supportive. That was a choice and it\'s being reviewed.',
          'The next time we call, it won\'t be to ask.'],
        ['The President will be saying something about you, and not from a stadium.',
          ...
          'You\'ll hear the position in the State of the Union.',
          'There\'s no longer anybody here who takes your call.',
          'Whatever happens to this office next, we won\'t be preventing it.'],
      ],
      streak: ['Three in a row. Somebody in here has started a file with your name on it.',
        'That\'s the third. The President has begun mentioning it unprompted.',
        'Three straight. We have stopped explaining you to people who ask.'],
      relief: ['That helps the story. It doesn\'t change the story.',
      ...
      grudge: ['We had moved on from that. Now we haven\'t.',
      ...
      on: {
        access: {
          good: ['More of the country gets to be in it. That\'s the whole argument, made for us.',
          ...
          bad: ['You have shut the door on most of the map and everybody can see which half.',
            'That\'s a decision the people who lost it will remember at a rally.'],
        },
        tradition: {
          good: ['That\'s the version of this country people like to be reminded of.',
            'You kept something. There\'s real value in that up here.'],
          bad: ['You\'re taking apart a thing families organise a weekend around.',
            'That reads as an institution deciding it knows better. It always plays badly.'],
        },
        exposure: {
          good: ['One fewer scandal is one fewer question. We\'re simple about this.',
            'That\'s a risk closed and we notice when you close one.'],
    ...
    'Host Nations': {
      bands: [
        ['We built for this. It\'s good to be treated as though we did.',
          'That\'s the first decision that assumed we were staying.',
        ...
        ['Acceptable. We were expecting less.',
          'We\'ll take it. It isn\'t equality and nobody said it was.',
          'That works. It\'s still a decision made without us in the room.',
          'Fine. We\'ll spend the money and say nothing.',
          'It\'s a step and we can count how many are left.',
          'We understand. We have understood for some years now.'],
        ['You keep treating us as a venue rather than as a member.',
          'We paid for the stadium and we\'re asked about the catering.',
          'That decision was about us and nobody called.',
          'There\'s a limit to how long a partner stays a guest.',
          'We funded three seasons of this. We would like a sentence in return.',
          'You wouldn\'t have done that to a conference.'],
        ['Our government is reviewing whether this relationship returns anything.',
          'There are other sports and all of them have asked.',
          'We can stop writing the cheque. It\'s the one thing we control.',
          'You have made the case internally for walking away, and we didn\'t have to.',
          'The next agreement will be negotiated by people less fond of you.',
          'We aren\'t a market. We keep having to say it.'],
        ['We\'re finished. The stadium will be used for something else.',
          'The funding stops and the announcement is already drafted.',
          'You\'ll find out what this sport is worth without us in it.',
          'We were the growth. You have declined to have any.',
          'There will be a league here. It won\'t be yours.',
          'Don\'t call. There\'s nobody here who will take it.'],
      ],
      streak: ['Three in a row. Our ministers have noticed and they count too.',
        'That\'s the third. There\'s a word for a pattern and we have used it.',
        'Three straight. We have begun asking what exactly we are paying for.'],
      relief: ['That\'s better. It doesn\'t make the last one acceptable.',
        'We\'ll report that home as progress. Modest progress.',
        'Helpful. We\'re still the ones who had to ask.',
      ...
      on: {
        inventory: {
          good: ['More football here is exactly what we paid for.',
            'Give us the fixtures and we\'ll fill them. We always have.'],
          bad: ['Fewer games and the ones cut are ours. It\'s always ours.',
        ...
        access: {
          good: ['A route in is all anybody ever wanted. Thank you.',
            'That\'s the difference between playing and being invited.'],
          bad: ['We can win everything here and still not be in that bracket.',
            'You have built a ceiling and told us it is a schedule.'],
        },
        tradition: {
          good: ['We\'re building our own. It helps when you don\'t trample it.',
    ...
    'The Programme': {
      bands: [
        ['That clears the manifest. We can fly it.',
          ...
          'That\'s an engineering answer to an engineering problem. Rare here.',
          'Our directors will approve the next one on the strength of that.',
          'You read the constraints. Nobody reads the constraints.',
          'That\'s a launch. Everything else in this building is a slide deck.'],
        ['It fits, with margin we don\'t love.',
          ...
          'Fine. We\'ll find the kilograms somewhere.',
          'Nobody is scrubbing. Nobody is comfortable either.'],
        ['That pushes us outside the window and the window doesn\'t move.',
          ...
          'Somebody in that room doesn\'t understand that orbits aren\'t negotiable.',
          'That isn\'t a delay. That\'s a different mission.'],
        ['Our funding is annual and this is the sort of thing that ends it.',
          ...
          'There\'s a version of the manifest without a football game on it.',
            'You\'re one more of these from being descoped.',
          'We have begun writing the memo that explains why we stopped.',
          'This programme doesn\'t need a sport. The sport needed us.'],
        ['The slot is reassigned. There\'s nothing to discuss.',
          'We\'re off the manifest and off the phone.',
          'Whatever you sanction next, it stays on the ground.',
          'You had a launch window. You have a press release.',
          'Our directors have closed the file and they don\'t reopen files.',
          'Don\'t call in March. There will be nothing in March.'],
      ],
      streak: ['Three in a row and every one cost us mass. That\'s a programme, not a run.',
        'Third one. We have started modelling this office as a schedule risk.',
        'Three straight. Our directors have asked, twice, why we\'re still doing this.'],
      relief: ['That recovers some margin. Not the cycle.',
        'Helpful. We\'re still outside where we wanted to be.',
        'That buys back kilograms. It doesn\'t buy back the window.',
        'Better. The mission is still the harder version of itself.'],
      grudge: ['We had closed that trade. It\'s open again.',
      ...
      on: {
        cost: {
          good: ['Every dollar there is a kilogram. You have just bought us a kilogram.',
            'That\'s money we can put into the vehicle instead of the paperwork.'],
          bad: ['That comes out of the vehicle. Everything comes out of the vehicle.',
            'You have spent our margin on a thing that doesn\'t fly.'],
        },
        inventory: {
          good: ['More kickoffs is more flights. We\'re simple about this.',
            'Give us the manifest and we\'ll make the window.'],
          bad: ['Fewer events and the hardware still costs what it costs.',
            'You have cut the one Saturday that justified the launch.'],
        },
        exposure: {
          good: ['Risk retired on the ground is risk that doesn\'t fly.',
          ...
          bad: ['You have put a kid in a helmet in vacuum with no actuarial table.',
            'That\'s a waiver a court has never seen before.'],
        },
      },
    },
  };
