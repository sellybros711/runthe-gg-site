...
// DEPRECATED legacy snapshot — DO NOT RUN. Canonical pipeline is at the project
// root: ../convertData.js (and ../convert_data.py). Kept for reference only.
const IN_PATH  = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_RERATED.json');
