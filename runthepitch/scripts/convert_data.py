# DEPRECATED legacy snapshot — DO NOT RUN. The canonical pipeline lives at the
# project root: ../convert_data.py (and ../convertData.js). This copy is kept for
# reference only; it lacks the RERATED source and the ballon_dor / is_icon fields.
...
IN_PATH  = os.path.join(BASE, 'data', 'world_cup_full_rosters_1966_2026_RERATED.json')
