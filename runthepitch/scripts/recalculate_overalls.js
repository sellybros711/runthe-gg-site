...
//
// Reads  data/world_cup_full_rosters_1966_2026_10.csv
...
const IN_PATH  = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_10.csv');
const OUT_PATH = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_2.csv');
