...
//
// Reads  data/world_cup_full_rosters_1966_2026_12.csv
// Writes data/world_cup_full_rosters_1966_2026_12.csv  (same data + position_overall)
//
...
const IN_PATH  = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_12.csv');
const OUT_PATH = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_12.csv');
