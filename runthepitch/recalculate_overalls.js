...
//
// Reads  data/world_cup_full_rosters_1966_2026_14.csv
// Writes data/world_cup_full_rosters_1966_2026_14.csv  (same data + position_overall)
//
...
const IN_PATH  = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_14.csv');
const OUT_PATH = path.join(__dirname, 'data', 'world_cup_full_rosters_1966_2026_14.csv');
