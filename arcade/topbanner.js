...
(function () {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '.rtg-topbanner .rtb-tokens.unlimited{color:var(--brandT,#FF8A3D);border-color:color-mix(in srgb,var(--brandT,#FF8A3D) 55%,transparent);}',
      '.rtg-topbanner .rtb-tokens.unlimited .tk-ic{color:var(--brandT,#FF8A3D);}',
