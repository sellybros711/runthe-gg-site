...
(function(root){
  ...
  var NBA_STARS = [
    ...
    'DeAndre Jordan','JJ Redick','Wes Matthews','Wesley Matthews','Marcus Smart','Jaylen Brown',
    'Al Horford','Gordon Hayward','Otto Porter','Bojan Bogdanovic','Bogdan Bogdanovic','Bogdan Bogdanovich',
    ...
    'Tobias Harris','Tyrese Maxey','James Harden','Kelly Oubre','Nic Batum','Nicolas Claxton',
    'Cam Thomas','Ben Simmons','Dennis Schroder','Cam Johnson','Grayson Allen','Bobby Portis',
  ...
  var NFL_STARS = [
    ...
    'Jamaal Williams','Aaron Jones','Rhamondre Stevenson','James Cook','Rachaad White','Isiah Pacheco',
  ...
  var MLB_STARS = [
    ...
    'Justin Upton','B.J. Upton','Melvin Upton Jr.','Adrian Beltre','Nelson Cruz','Robinson Cano',
