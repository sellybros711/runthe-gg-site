// Generate og-watch.png (1200×630) — challenge-specific link-preview card.
...
x.fillStyle=cream;
const L1='WATCH HOW THE MATCH', L2='PLAYED OUT';
...
fs.writeFileSync('og-watch.png', c.toBuffer('image/png'));
console.log('wrote og-watch.png', fs.statSync('og-watch.png').size, 'bytes');
