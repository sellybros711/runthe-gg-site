...
the homepage game card + sitemap entry) when it's ready to ship, the same pattern the
other two games use.
...
- **Split Path** (choose 1 of 2, brain+reflex pairing preference) and **Solo Call**
  (one assigned task), per GDD §5. Selection actively diversifies game types across
