  ...
  window.GLOBE_COUNTRIES = [
    /* ---------------------------------------------------------------- Japan */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ¥1,500? (¥150 = $1)", options: ["$5", "$10", "$15", "$100"], a: 1 },
        ],
        spatial: [
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the lantern sequence", tiles: ["🏮", "⛩️", "🗾", "🎌", "🍣"] }],
    ...
    /* -------------------------------------------------------------- Brazil */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is R$50? (R$5 = $1)", options: ["$5", "$10", "$25", "$250"], a: 1 },
        ],
        spatial: [
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the carnival sequence", tiles: ["🎭", "🥁", "🦜", "⚽", "🌴"] }],
    ...
    /* ---------------------------------------------------------------- Italy */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the piazza sequence", tiles: ["🍝", "🏛️", "🚤", "🍕", "⛲"] }],
    ...
    /* --------------------------------------------------------------- Egypt */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the tomb sequence", tiles: ["🐪", "🔺", "𓂀", "🏜️", "⚱️"] }],
    ...
    /* --------------------------------------------------------------- France */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the café sequence", tiles: ["🗼", "🥐", "🎨", "🧀", "🚄"] }],
    ...
    /* ------------------------------------------------------------- Australia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is A$30? (A$1.5 = $1)", options: ["$15", "$20", "$45", "$60"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities west → east", dir: "west", unit: "",
            items: [{ label: "Perth", value: 116 }, { label: "Adelaide", value: 138 }, { label: "Melbourne", value: 145 }, { label: "Sydney", value: 151 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the outback sequence", tiles: ["🦘", "🐨", "🏄", "🌊", "🎭"] }],
    ...
    /* --------------------------------------------------------------- Mexico */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 200 pesos? (20 pesos = $1)", options: ["$5", "$10", "$20", "$40"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order by population, largest → smallest", dir: "desc", unit: "M",
            items: [{ label: "Mexico City", value: 9.2 }, { label: "Guadalajara", value: 1.5 }, { label: "Monterrey", value: 1.1 }, { label: "Cancún", value: 0.9 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the fiesta sequence", tiles: ["🌮", "🌵", "🎸", "🏛️", "🌶️"] }],
    ...
    /* ----------------------------------------------------------------- India */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 800 rupees? (80 rupees = $1)", options: ["$8", "$10", "$16", "$80"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "New Delhi", value: 28 }, { label: "Mumbai", value: 19 }, { label: "Bengaluru", value: 13 }, { label: "Chennai", value: 13 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the bazaar sequence", tiles: ["🕌", "🐘", "🌶️", "🪷", "🚂"] }],
    ...
    /* ----------------------------------------------------------------- Kenya */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the savanna sequence", tiles: ["🦁", "🐘", "🦒", "🌍", "🌅"] }],
    ...
    /* ----------------------------------------------------------------- Canada */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is C$40? (C$1.25 = $1)", options: ["$25", "$32", "$40", "$50"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities west → east", dir: "west", unit: "",
            items: [{ label: "Vancouver", value: -123 }, { label: "Calgary", value: -114 }, { label: "Toronto", value: -79 }, { label: "Montreal", value: -73 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the north sequence", tiles: ["🍁", "🏒", "🦫", "🏔️", "⛸️"] }],
    ...
    /* ---------------------------------------------------------------- Greece */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Aegean sequence", tiles: ["🏛️", "🫒", "⚓", "🏺", "☀️"] }],
    ...
    /* -------------------------------------------------------------- Thailand */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 350 baht? (35 baht = $1)", options: ["$5", "$10", "$35", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Chiang Mai", value: 19 }, { label: "Bangkok", value: 14 }, { label: "Surat Thani", value: 9 }, { label: "Phuket", value: 8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the market sequence", tiles: ["🛕", "🐘", "🌶️", "🛶", "🏝️"] }],
    ...
    /* ---------------------------------------------------------------- Spain */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the flamenco sequence", tiles: ["💃", "🥘", "🎸", "🐂", "🏰"] }],
    ...
    /* -------------------------------------------------------------- Germany */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the festival sequence", tiles: ["🍺", "🥨", "🏰", "🚗", "🌲"] }],
    ...
    /* -------------------------------------------------------- United Kingdom */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the royal sequence", tiles: ["🎡", "☂️", "🚌", "👑", "☕"] }],
    ...
    /* ------------------------------------------------------------- Portugal */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the coastal sequence", tiles: ["🍷", "⛵", "🐟", "🏰", "🌊"] }],
    ...
    /* ---------------------------------------------------------- Netherlands */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "A bike rental is €8. Rent 3. Total?", options: ["€16", "€21", "€24", "€32"], a: 2 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Groningen", value: 53 }, { label: "Amsterdam", value: 52 }, { label: "Rotterdam", value: 51 }, { label: "Maastricht", value: 50 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the canal sequence", tiles: ["🌷", "🚲", "🧀", "⛵", "🪟"] }],
    ...
    /* --------------------------------------------------------------- Ireland */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the emerald sequence", tiles: ["🍀", "🎻", "🏰", "🌈", "🐑"] }],
    ...
    /* ---------------------------------------------------------------- Sweden */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 100 kronor? (10 kronor = $1)", options: ["$5", "$10", "$20", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Kiruna", value: 67 }, { label: "Stockholm", value: 59 }, { label: "Gothenburg", value: 57 }, { label: "Malmö", value: 55 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Nordic sequence", tiles: ["❄️", "🎿", "🛶", "🌲", "🦌"] }],
    ...
    /* ---------------------------------------------------------------- Norway */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 200 kroner? (10 kroner = $1)", options: ["$10", "$20", "$40", "$200"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Tromsø", value: 69 }, { label: "Trondheim", value: 63 }, { label: "Bergen", value: 60 }, { label: "Oslo", value: 59 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the fjord sequence", tiles: ["🏔️", "⛴️", "🐟", "❄️", "🌌"] }],
    ...
    /* ----------------------------------------------------------- Switzerland */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "About how many US dollars is 20 francs? (1 franc = $1.10)", options: ["$18", "$22", "$25", "$30"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Basel", value: 47.6 }, { label: "Zurich", value: 47.4 }, { label: "Bern", value: 46.9 }, { label: "Lugano", value: 46.0 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Alpine sequence", tiles: ["🏔️", "🍫", "⌚", "🧀", "🐄"] }],
    ...
    /* ---------------------------------------------------------------- Turkey */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 300 lira? (30 lira = $1)", options: ["$3", "$10", "$30", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Istanbul", value: 41 }, { label: "Ankara", value: 40 }, { label: "Izmir", value: 38 }, { label: "Antalya", value: 37 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the bazaar sequence", tiles: ["🕌", "🎈", "🍵", "🧿", "🌙"] }],
    ...
    /* ---------------------------------------------------------------- Russia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 700 rubles? (70 rubles = $1)", options: ["$7", "$10", "$70", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "St. Petersburg", value: 60 }, { label: "Moscow", value: 56 }, { label: "Volgograd", value: 49 }, { label: "Sochi", value: 43 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the winter palace sequence", tiles: ["🏰", "❄️", "🪆", "🐻", "⛪"] }],
    ...
    /* ---------------------------------------------------------------- Poland */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 40 zloty? (4 zloty = $1)", options: ["$4", "$10", "$40", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Gdańsk", value: 54 }, { label: "Warsaw", value: 52 }, { label: "Wrocław", value: 51 }, { label: "Kraków", value: 50 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the old town sequence", tiles: ["🏰", "🥟", "⛪", "🎻", "🌲"] }],
    ...
    /* ----------------------------------------------------------------- China */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 70 yuan? (7 yuan = $1)", options: ["$7", "$10", "$70", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Beijing", value: 40 }, { label: "Xi'an", value: 34 }, { label: "Shanghai", value: 31 }, { label: "Guangzhou", value: 23 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the dynasty sequence", tiles: ["🐉", "🏯", "🏮", "🐼", "🍜"] }],
    ...
    /* ----------------------------------------------------------- South Korea */
    {
      ...
      tasks: {
        trivia: [
          ...
          { cat: "trivia", type: "brain", q: "Gyeongbokgung is a famous royal ____ in Seoul.", options: ["Bridge", "Palace", "Stadium", "Harbor"], a: 1 },
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 13,000 won? (1,300 won = $1)", options: ["$1", "$10", "$13", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Seoul", value: 37.5 }, { label: "Daejeon", value: 36.3 }, { label: "Daegu", value: 35.9 }, { label: "Busan", value: 35.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the K-pop sequence", tiles: ["🏯", "🥬", "🎤", "🍜", "🌸"] }],
    ...
    /* --------------------------------------------------------------- Vietnam */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the delta sequence", tiles: ["🛶", "🍜", "🎋", "🏝️", "🌾"] }],
    ...
    /* ------------------------------------------------------------- Indonesia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 150,000 rupiah? (15,000 rupiah = $1)", options: ["$1", "$10", "$15", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Medan", value: 3.5 }, { label: "Jakarta", value: -6 }, { label: "Surabaya", value: -7 }, { label: "Denpasar", value: -8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the archipelago sequence", tiles: ["🏝️", "🐉", "🛕", "🌋", "🌊"] }],
    ...
    /* ----------------------------------------------------------- Philippines */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 560 pesos? (56 pesos = $1)", options: ["$6", "$10", "$56", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Baguio", value: 16 }, { label: "Manila", value: 15 }, { label: "Cebu", value: 10 }, { label: "Davao", value: 7 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the island sequence", tiles: ["🏝️", "🌴", "🐠", "🛶", "☀️"] }],
    ...
    /* ------------------------------------------------------------- Singapore */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the skyline sequence", tiles: ["🦁", "🌆", "🌳", "🍜", "🎡"] }],
    ...
    /* --------------------------------------------------- United Arab Emirates */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 37 dirham? (3.7 dirham = $1)", options: ["$3.70", "$10", "$37", "$100"], a: 1 },
        ],
        spatial: [
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the skyline sequence", tiles: ["🏙️", "🐫", "🏝️", "🕌", "🌇"] }],
    ...
    /* ---------------------------------------------------------- Saudi Arabia */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the desert sequence", tiles: ["🐫", "🏜️", "🕌", "🌴", "⭐"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "Tap when the desert sun flashes green" }],
      },
    },
    /* ---------------------------------------------------------------- Israel */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 36 shekels? (3.6 shekels = $1)", options: ["$3.60", "$10", "$36", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Haifa", value: 32.8 }, { label: "Tel Aviv", value: 32.1 }, { label: "Jerusalem", value: 31.8 }, { label: "Eilat", value: 29.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the old city sequence", tiles: ["🕍", "🕌", "⛪", "🌊", "🏜️"] }],
    ...
    /* ----------------------------------------------------------------- Nepal */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 1,300 rupees? (130 rupees = $1)", options: ["$1", "$10", "$13", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Pokhara", value: 28.2 }, { label: "Kathmandu", value: 27.7 }, { label: "Birgunj", value: 27.0 }, { label: "Biratnagar", value: 26.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Himalayan sequence", tiles: ["🏔️", "🚩", "🛕", "🧗", "🌄"] }],
    ...
    /* ---------------------------------------------------------- South Africa */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 180 rand? (18 rand = $1)", options: ["$8", "$10", "$18", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Pretoria", value: -25.7 }, { label: "Johannesburg", value: -26.2 }, { label: "Durban", value: -29.9 }, { label: "Cape Town", value: -33.9 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the safari sequence", tiles: ["🦁", "🐘", "🦓", "⛰️", "💎"] }],
    ...
    /* --------------------------------------------------------------- Morocco */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 100 dirham? (10 dirham = $1)", options: ["$1", "$10", "$100", "$1000"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Tangier", value: 35.8 }, { label: "Rabat", value: 34.0 }, { label: "Casablanca", value: 33.6 }, { label: "Marrakech", value: 31.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the medina sequence", tiles: ["🕌", "🐫", "🫖", "🏜️", "🧵"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "Tap when the lantern light flashes green" }],
      },
    },
    /* --------------------------------------------------------------- Nigeria */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 15,000 naira? (1,500 naira = $1)", options: ["$1", "$10", "$15", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Kano", value: 12 }, { label: "Abuja", value: 9 }, { label: "Ibadan", value: 7 }, { label: "Lagos", value: 6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the market sequence", tiles: ["🥁", "🎬", "🌍", "🛶", "🌴"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "Tap when the market lamp flashes green" }],
      },
    },
    /* -------------------------------------------------------------- Tanzania */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 25,000 shillings? (2,500 shillings = $1)", options: ["$1", "$10", "$25", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Mwanza", value: -2.5 }, { label: "Arusha", value: -3.4 }, { label: "Dodoma", value: -6.2 }, { label: "Dar es Salaam", value: -6.8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the savanna sequence", tiles: ["🦁", "🏔️", "🦓", "🏝️", "🌅"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "Tap when the savanna sun flashes green" }],
      },
    },
    /* -------------------------------------------------------------- Ethiopia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 550 birr? (55 birr = $1)", options: ["$5", "$10", "$55", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Mekelle", value: 13.5 }, { label: "Dire Dawa", value: 9.6 }, { label: "Addis Ababa", value: 9.0 }, { label: "Hawassa", value: 7.0 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the coffee sequence", tiles: ["☕", "🌄", "🛕", "🌿", "🌅"] }],
    ...
    /* -------------------------------------------------------- United States */
    {
      ...
      tasks: {
        trivia: [
          ...
          { cat: "trivia", type: "brain", q: "The Statue of Liberty stands in the harbor of which city?", options: ["Boston", "New York", "Miami", "Seattle"], a: 1 },
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the landmark sequence", tiles: ["🗽", "🦅", "🏔️", "🎬", "🌉"] }],
    ...
    /* ------------------------------------------------------------- Argentina */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 9,000 pesos? (900 pesos = $1)", options: ["$1", "$10", "$90", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Salta", value: -24.8 }, { label: "Córdoba", value: -31.4 }, { label: "Buenos Aires", value: -34.6 }, { label: "Ushuaia", value: -54.8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the tango sequence", tiles: ["💃", "🥩", "⚽", "🏔️", "🧉"] }],
    ...
    /* ------------------------------------------------------------------ Peru */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 38 soles? (3.8 soles = $1)", options: ["$3.80", "$10", "$38", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Piura", value: -5 }, { label: "Lima", value: -12 }, { label: "Cusco", value: -13.5 }, { label: "Arequipa", value: -16 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Inca sequence", tiles: ["🦙", "🏔️", "🛕", "🌽", "🎶"] }],
    ...
    /* ----------------------------------------------------------------- Chile */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Andean sequence", tiles: ["🏔️", "🏜️", "🍷", "🌊", "⭐"] }],
    ...
    /* -------------------------------------------------------------- Colombia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 40,000 pesos? (4,000 pesos = $1)", options: ["$1", "$10", "$40", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ------------------------------------------------------------------ Cuba */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Havana sequence", tiles: ["🚗", "🎺", "🌴", "🚬", "💃"] }],
    ...
    /* ----------------------------------------------------------- New Zealand */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is NZ$32? (NZ$1.6 = $1)", options: ["$16", "$20", "$32", "$40"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Auckland", value: -36.8 }, { label: "Wellington", value: -41.3 }, { label: "Christchurch", value: -43.5 }, { label: "Dunedin", value: -45.9 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the kiwi sequence", tiles: ["🥝", "🐑", "🏔️", "🏉", "🌊"] }],
    ...
    /* ------------------------------------------------------------- Finland */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is €45? (€0.9 = $1)", options: ["$40", "$45", "$50", "$55"], a: 2 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Rovaniemi", value: 66.5 }, { label: "Oulu", value: 65.0 }, { label: "Tampere", value: 61.5 }, { label: "Helsinki", value: 60.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the sauna sequence", tiles: ["🧖", "🌲", "❄️", "🦌", "🏒"] }],
    ...
    /* ------------------------------------------------------------- Denmark */
    {
      ...
      tasks: {
        trivia: [
          { cat: "trivia", type: "brain", q: "The Little Mermaid statue sits in the harbor of which capital?", options: ["Oslo", "Stockholm", "Copenhagen", "Amsterdam"], a: 2 },
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is kr140? (kr7 = $1)", options: ["$10", "$20", "$70", "$140"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Aalborg", value: 57.0 }, { label: "Aarhus", value: 56.2 }, { label: "Copenhagen", value: 55.7 }, { label: "Odense", value: 55.4 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the harbor sequence", tiles: ["⚓", "🧜‍♀️", "🚲", "🧱", "🍺"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "React at the harbor signal" }],
      },
    },
    /* ------------------------------------------------------------- Belgium */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is €36? (€0.9 = $1)", options: ["$32", "$36", "$40", "$44"], a: 2 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Antwerp", value: 51.2 }, { label: "Ghent", value: 51.0 }, { label: "Brussels", value: 50.8 }, { label: "Charleroi", value: 50.4 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the waffle sequence", tiles: ["🧇", "🍫", "🍟", "🍺", "🎨"] }],
    ...
    /* ------------------------------------------------------------- Austria */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is €24? (€0.8 = $1)", options: ["$24", "$30", "$36", "$48"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ------------------------------------------------------------- Czechia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Kč240? (Kč24 = $1)", options: ["$5", "$10", "$24", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Liberec", value: 50.8 }, { label: "Prague", value: 50.1 }, { label: "Ostrava", value: 49.8 }, { label: "Brno", value: 49.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the castle sequence", tiles: ["🏰", "🍺", "🕰️", "🌉", "🎭"] }],
    ...
    /* ------------------------------------------------------------- Hungary */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Ft3000? (Ft300 = $1)", options: ["$3", "$10", "$30", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Miskolc", value: 48.1 }, { label: "Debrecen", value: 47.6 }, { label: "Budapest", value: 47.5 }, { label: "Szeged", value: 46.3 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the thermal-bath sequence", tiles: ["♨️", "🌉", "🌶️", "🍲", "🎻"] }],
    ...
    /* ------------------------------------------------------------- Romania */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is lei45? (lei4.5 = $1)", options: ["$4", "$10", "$45", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ------------------------------------------------------------- Ukraine */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₴400? (₴40 = $1)", options: ["$4", "$10", "$40", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Kyiv", value: 50.5 }, { label: "Kharkiv", value: 50.0 }, { label: "Lviv", value: 49.8 }, { label: "Odesa", value: 46.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the wheat-field sequence", tiles: ["🌻", "🌾", "⛪", "🕊️", "🟦"] }],
    ...
    /* ------------------------------------------------------------- Croatia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is €18? (€0.9 = $1)", options: ["$16", "$18", "$20", "$22"], a: 2 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Zagreb", value: 45.8 }, { label: "Rijeka", value: 45.3 }, { label: "Split", value: 43.5 }, { label: "Dubrovnik", value: 42.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the coastal sequence", tiles: ["🏰", "⛵", "🌊", "🐬", "🏝️"] }],
    ...
    /* ------------------------------------------------------------- Iceland */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is kr1400? (kr140 = $1)", options: ["$5", "$10", "$14", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Akureyri", value: 65.7 }, { label: "Reykjavik", value: 64.1 }, { label: "Keflavik", value: 64.0 }, { label: "Vik", value: 63.4 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the volcanic sequence", tiles: ["🌋", "♨️", "🧊", "🐋", "🌌"] }],
    ...
    /* ------------------------------------------------------------ Slovakia */
    {
      ...
      tasks: {
        trivia: [
          ...
          { cat: "trivia", type: "brain", q: "The High Tatras mountain range lies in Slovakia and which neighbor?", options: ["Poland", "Austria", "Ukraine", "Germany"], a: 0 },
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is €35? (€0.7 = $1)", options: ["$35", "$42", "$50", "$70"], a: 2 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Žilina", value: 49.2 }, { label: "Prešov", value: 49.0 }, { label: "Košice", value: 48.7 }, { label: "Bratislava", value: 48.1 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the mountain sequence", tiles: ["🏔️", "🏰", "🌲", "🐻", "🌉"] }],
    ...
    /* ------------------------------------------------------------ Bulgaria */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is лв20? (лв2 = $1)", options: ["$2", "$10", "$20", "$40"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Ruse", value: 43.9 }, { label: "Varna", value: 43.2 }, { label: "Sofia", value: 42.7 }, { label: "Plovdiv", value: 42.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the rose sequence", tiles: ["🌹", "🏔️", "🏖️", "⛪", "🍶"] }],
    ...
    /* -------------------------------------------------------------- Serbia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is din1200? (din120 = $1)", options: ["$5", "$10", "$12", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Subotica", value: 46.1 }, { label: "Novi Sad", value: 45.3 }, { label: "Belgrade", value: 44.8 }, { label: "Niš", value: 43.3 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the fortress sequence", tiles: ["🏰", "🌉", "🎶", "🍇", "⛪"] }],
    ...
    /* ------------------------------------------------------------ Malaysia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is RM40? (RM4 = $1)", options: ["$4", "$10", "$40", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "George Town", value: 5.4 }, { label: "Ipoh", value: 4.6 }, { label: "Kuala Lumpur", value: 3.1 }, { label: "Johor Bahru", value: 1.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the rainforest sequence", tiles: ["🌴", "🦧", "🏙️", "🌺", "🍜"] }],
    ...
    /* ------------------------------------------------------------ Pakistan */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Rs2800? (Rs280 = $1)", options: ["$10", "$28", "$100", "$280"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ---------------------------------------------------------- Bangladesh */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Tk1100? (Tk110 = $1)", options: ["$10", "$11", "$100", "$110"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Rangpur", value: 25.7 }, { label: "Rajshahi", value: 24.4 }, { label: "Dhaka", value: 23.8 }, { label: "Chittagong", value: 22.3 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the delta sequence", tiles: ["🐅", "🚣", "🌊", "🍛", "🛕"] }],
    ...
    /* ----------------------------------------------------------- Sri Lanka */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Rs600? (Rs300 = $1)", options: ["$2", "$3", "$6", "$60"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Jaffna", value: 9.7 }, { label: "Kandy", value: 7.3 }, { label: "Colombo", value: 6.9 }, { label: "Galle", value: 6.0 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the tea-garden sequence", tiles: ["🍵", "🐘", "🌴", "🏝️", "🪷"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "React at the harbor signal" }],
      },
    },
    /* ------------------------------------------------------------ Cambodia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ៛40000? (៛4000 = $1)", options: ["$4", "$10", "$40", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Siem Reap", value: 13.4 }, { label: "Battambang", value: 13.1 }, { label: "Phnom Penh", value: 11.6 }, { label: "Sihanoukville", value: 10.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the temple sequence", tiles: ["🛕", "🌾", "🚣", "🐒", "🌴"] }],
    ...
    /* ------------------------------------------------------------- Myanmar */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is K21000? (K2100 = $1)", options: ["$10", "$21", "$100", "$210"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Mandalay", value: 22.0 }, { label: "Naypyidaw", value: 19.8 }, { label: "Bago", value: 17.3 }, { label: "Yangon", value: 16.8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the pagoda sequence", tiles: ["🛕", "🌾", "🐘", "🎈", "🌅"] }],
    ...
    /* ---------------------------------------------------------- Kazakhstan */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₸4500? (₸450 = $1)", options: ["$4", "$10", "$45", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Astana", value: 51.2 }, { label: "Karaganda", value: 49.8 }, { label: "Almaty", value: 43.2 }, { label: "Shymkent", value: 42.3 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the steppe sequence", tiles: ["🐎", "🦅", "🏙️", "🌾", "🚀"] }],
    ...
    /* ---------------------------------------------------------- Uzbekistan */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 120,000 so'm? (12,000 = $1)", options: ["$10", "$12", "$100", "$120"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Tashkent", value: 41.3 }, { label: "Bukhara", value: 39.8 }, { label: "Samarkand", value: 39.7 }, { label: "Termez", value: 37.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Silk Road sequence", tiles: ["🕌", "🐫", "🧵", "🍶", "🌇"] }],
    ...
    /* ---------------------------------------------------------------- Iran */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is 500,000 rials? (50,000 = $1)", options: ["$1", "$5", "$10", "$100"], a: 2 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Tabriz", value: 38.1 }, { label: "Tehran", value: 35.7 }, { label: "Isfahan", value: 32.7 }, { label: "Shiraz", value: 29.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Persian sequence", tiles: ["🕌", "🐆", "🌹", "🍶", "🏺"] }],
    ...
    /* ---------------------------------------------------------------- Iraq */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ID13000? (ID1300 = $1)", options: ["$10", "$13", "$100", "$130"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Mosul", value: 36.3 }, { label: "Kirkuk", value: 35.5 }, { label: "Baghdad", value: 33.3 }, { label: "Basra", value: 30.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the ancient-river sequence", tiles: ["🏛️", "🌊", "🐪", "🕌", "📜"] }],
    ...
    /* -------------------------------------------------------------- Taiwan */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is NT$320? (NT$32 = $1)", options: ["$3", "$10", "$32", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Taipei", value: 25.0 }, { label: "Taichung", value: 24.1 }, { label: "Tainan", value: 23.0 }, { label: "Kaohsiung", value: 22.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the night-market sequence", tiles: ["🏙️", "🥟", "🧋", "🏮", "⛩️"] }],
    ...
    /* ---------------------------------------------------------- Azerbaijan */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₼17? (₼1.7 = $1)", options: ["$7", "$10", "$17", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Ganja", value: 40.7 }, { label: "Sumqayit", value: 40.6 }, { label: "Baku", value: 40.4 }, { label: "Lankaran", value: 38.8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the flame-tower sequence", tiles: ["🔥", "🛢️", "🌊", "🕌", "🏙️"] }],
    ...
    /* ------------------------------------------------------------- Georgia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₾27? (₾2.7 = $1)", options: ["$7", "$10", "$27", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Kutaisi", value: 42.3 }, { label: "Tbilisi", value: 41.7 }, { label: "Batumi", value: 41.6 }, { label: "Rustavi", value: 41.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the vineyard sequence", tiles: ["🍇", "🍷", "🏔️", "⛪", "🌊"] }],
    ...
    /* --------------------------------------------------------------- Qatar */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is QR36? (QR3.6 = $1)", options: ["$3", "$10", "$36", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Al Ruwais", value: 26.1 }, { label: "Al Khor", value: 25.7 }, { label: "Doha", value: 25.3 }, { label: "Al Wakrah", value: 25.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the desert sequence", tiles: ["🏙️", "🐫", "⚽", "🏜️", "🛢️"] }],
    ...
    /* -------------------------------------------------------------- Kuwait */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the oilfield sequence", tiles: ["🛢️", "🏙️", "🐫", "🌊", "🕌"] }],
    ...
    /* -------------------------------------------------------------- Jordan */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the desert-canyon sequence", tiles: ["🏜️", "🐫", "🏛️", "🧂", "⛺"] }],
    ...
    /* ------------------------------------------------------------- Lebanon */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the cedar sequence", tiles: ["🌲", "🏛️", "🌊", "🍋", "⛰️"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "React at the harborfront signal" }],
      },
    },
    /* ---------------------------------------------------------------- Oman */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the frankincense sequence", tiles: ["🕌", "🐫", "🏜️", "🌊", "🪔"] }],
        reflex: [{ cat: "reflex", type: "reflex", prompt: "React at the harbor fort signal" }],
      },
    },
    /* --------------------------------------------------------------- Ghana */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₵120? (₵12 = $1)", options: ["$10", "$12", "$100", "$120"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Tamale", value: 9.4 }, { label: "Kumasi", value: 6.7 }, { label: "Accra", value: 5.6 }, { label: "Takoradi", value: 4.9 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the cocoa sequence", tiles: ["🍫", "🥁", "🌊", "⚽", "🪘"] }],
    ...
    /* ------------------------------------------------------- Côte d'Ivoire */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is CFA6000? (CFA600 = $1)", options: ["$6", "$10", "$60", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Korhogo", value: 9.5 }, { label: "Bouaké", value: 7.7 }, { label: "Yamoussoukro", value: 6.8 }, { label: "Abidjan", value: 5.4 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the cocoa-coast sequence", tiles: ["🍫", "🌴", "⚽", "🥁", "🌊"] }],
    ...
    /* ------------------------------------------------------------- Senegal */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is CFA3000? (CFA600 = $1)", options: ["$3", "$5", "$30", "$50"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ------------------------------------------------------------- Algeria */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is DA1350? (DA135 = $1)", options: ["$10", "$13", "$100", "$135"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Algiers", value: 36.8 }, { label: "Constantine", value: 36.4 }, { label: "Oran", value: 35.7 }, { label: "Tamanrasset", value: 22.8 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Sahara sequence", tiles: ["🏜️", "🐫", "🕌", "🛢️", "🌊"] }],
    ...
    /* ------------------------------------------------------------- Tunisia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is DT30? (DT3 = $1)", options: ["$3", "$10", "$30", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* -------------------------------------------------------------- Uganda */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is USh37000? (USh3700 = $1)", options: ["$10", "$37", "$100", "$370"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Gulu", value: 2.8 }, { label: "Kampala", value: 0.3 }, { label: "Entebbe", value: 0.1 }, { label: "Mbarara", value: -0.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the safari sequence", tiles: ["🦍", "🌊", "🌍", "🐘", "🌿"] }],
    ...
    /* ------------------------------------------------------------ Zimbabwe */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "If a falls tour costs $45 and you pay with a $100 bill, how much change?", options: ["$45", "$55", "$65", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Harare", value: -17.8 }, { label: "Mutare", value: -19.0 }, { label: "Gweru", value: -19.5 }, { label: "Bulawayo", value: -20.2 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the waterfall sequence", tiles: ["💦", "🌊", "🐘", "🪨", "🌈"] }],
    ...
    /* ---------------------------------------------------------- Mozambique */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is MT640? (MT64 = $1)", options: ["$6", "$10", "$64", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ---------------------------------------------------------- Madagascar */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Ar45000? (Ar4500 = $1)", options: ["$10", "$45", "$100", "$450"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Antsiranana", value: -12.3 }, { label: "Mahajanga", value: -15.7 }, { label: "Antananarivo", value: -18.9 }, { label: "Toliara", value: -23.4 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the rainforest sequence", tiles: ["🦎", "🌴", "🐒", "🦋", "🌺"] }],
    ...
    /* ------------------------------------------------------------ Cameroon */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is CFA1800? (CFA600 = $1)", options: ["$3", "$6", "$18", "$30"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* -------------------------------------------------------------- Angola */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Kz8300? (Kz830 = $1)", options: ["$10", "$83", "$100", "$830"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* ----------------------------------------------------------- Guatemala */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Q75? (Q7.5 = $1)", options: ["$7", "$10", "$75", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Cobán", value: 15.5 }, { label: "Quetzaltenango", value: 14.8 }, { label: "Guatemala City", value: 14.6 }, { label: "Escuintla", value: 14.3 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Mayan sequence", tiles: ["🛕", "🌋", "🦜", "🌽", "🥑"] }],
    ...
    /* ---------------------------------------------------------- Costa Rica */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₡5000? (₡500 = $1)", options: ["$5", "$10", "$50", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
    ...
    /* -------------------------------------------------- Dominican Republic */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is RD$600? (RD$60 = $1)", options: ["$6", "$10", "$60", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Puerto Plata", value: 19.8 }, { label: "Santiago", value: 19.5 }, { label: "La Vega", value: 19.2 }, { label: "Santo Domingo", value: 18.5 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Caribbean sequence", tiles: ["⚾", "🏝️", "🌴", "🥁", "🌊"] }],
    ...
    /* ------------------------------------------------------------- Jamaica */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is J$1500? (J$150 = $1)", options: ["$10", "$15", "$100", "$150"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Montego Bay", value: 18.5 }, { label: "Ocho Rios", value: 18.4 }, { label: "Mandeville", value: 18.0 }, { label: "Kingston", value: 17.9 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the reggae sequence", tiles: ["🎵", "🏝️", "🌴", "🥁", "☕"] }],
    ...
    /* ------------------------------------------------------------- Ecuador */
    {
      ...
      tasks: {
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the Galápagos sequence", tiles: ["🐢", "🦎", "🌋", "🐧", "🏝️"] }],
    ...
    /* ------------------------------------------------------------- Bolivia */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Bs70? (Bs7 = $1)", options: ["$7", "$10", "$70", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "La Paz", value: -16.5 }, { label: "Cochabamba", value: -17.4 }, { label: "Sucre", value: -19.0 }, { label: "Potosí", value: -19.6 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the salt-flat sequence", tiles: ["🧂", "🏔️", "🦙", "🌄", "🛖"] }],
    ...
    /* ------------------------------------------------------------- Uruguay */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is $U450? ($U45 = $1)", options: ["$10", "$45", "$100", "$450"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Salto", value: -31.4 }, { label: "Paysandú", value: -32.3 }, { label: "Montevideo", value: -34.9 }, { label: "Punta del Este", value: -35.0 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the football sequence", tiles: ["⚽", "🥩", "🧉", "🌊", "🐎"] }],
    ...
    /* ------------------------------------------------------------ Paraguay */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is ₲70000? (₲7000 = $1)", options: ["$7", "$10", "$70", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
        ...
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the river sequence", tiles: ["🌊", "⚡", "🌿", "🧉", "🐆"] }],
    ...
    /* ----------------------------------------------------------- Venezuela */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is Bs130? (Bs13 = $1)", options: ["$10", "$13", "$100", "$130"], a: 0 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Maracaibo", value: 10.7 }, { label: "Caracas", value: 10.5 }, { label: "Valencia", value: 10.2 }, { label: "Ciudad Bolívar", value: 8.1 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the waterfall sequence", tiles: ["💦", "🌊", "🛢️", "🏞️", "🦜"] }],
    ...
    /* ---------------------------------------------------------------- Fiji */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is FJ$22? (FJ$2.2 = $1)", options: ["$2", "$10", "$22", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
            items: [{ label: "Labasa", value: -16.4 }, { label: "Lautoka", value: -17.6 }, { label: "Nadi", value: -17.8 }, { label: "Suva", value: -18.1 }] },
        ],
        memory: [{ cat: "memory", type: "reflex", prompt: "Memorize the island sequence", tiles: ["🏝️", "🌊", "🐠", "🥥", "🏉"] }],
    ...
    /* --------------------------------------------------- Papua New Guinea */
    {
      ...
      tasks: {
        ...
        math: [
          { cat: "math", type: "brain", q: "How many US dollars is K30? (K3 = $1)", options: ["$3", "$10", "$30", "$100"], a: 1 },
        ],
        spatial: [
          { cat: "spatial", type: "brain", q: "Order these cities north → south", dir: "north", unit: "",
