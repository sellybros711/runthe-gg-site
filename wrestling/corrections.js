/* ============================================================
   ...
   Coverage (v0.3): a deep pass across ALL eight promotions (invented names, real workers).
...
window.RTR_CORRECTIONS = {
  // ================= Colossus Wrestling =================
  w0001: { age:40, inRing:85, psych:83, ent:92, phys:80, overness:91 }, // Cody Runnels
  w0002: { age:40, inRing:83, psych:88, ent:90, phys:82, overness:93 }, // Joe Anoa'i
  w0003: { age:39, inRing:90, psych:86, ent:88, phys:82, overness:91 }, // Colby Lopez
  w0004: { age:47, inRing:82, psych:88, ent:94, phys:68, overness:92 }, // Phil Brooks
  w0005: { age:38, inRing:88, psych:87, ent:74, phys:85, overness:85 }, // Walter Hahn
  w0006: { age:29, inRing:84, psych:80, ent:82, phys:84, overness:90 }, // Demi Bennett
  w0007: { age:36, inRing:82, psych:74, ent:80, phys:88, overness:84 }, // Bianca Crawford
  w0008: { age:33, inRing:82, psych:74, ent:76, phys:86, overness:80 }, // Jacob Fatu
  w0009: { age:40, inRing:80, psych:78, ent:88, phys:78, overness:90 }, // Joshua Fatu
  w0010: { age:40, inRing:78, psych:76, ent:76, phys:78, overness:74 }, // Jonathan Fatu
  w0011: { age:43, inRing:78, psych:74, ent:78, phys:84, overness:78 }, // Luis Martinez
  w0012: { age:40, inRing:84, psych:82, ent:84, phys:86, overness:82 }, // Drew Galloway
  w0013: { age:43, inRing:74, psych:72, ent:88, phys:74, overness:80 }, // Shaun Ricker
  w0014: { age:45, inRing:86, psych:92, ent:84, phys:76, overness:84 }, // Randy Orton
  w0015: { age:31, inRing:78, psych:74, ent:80, phys:76, overness:78 }, // Gionna Daddio
  w0016: { age:35, inRing:90, psych:82, ent:66, phys:82, overness:80 }, // Masami Odate
  w0017: { age:28, inRing:82, psych:72, ent:74, phys:88, overness:82 }, // Bronson Rechsteiner
  w0018: { age:41, inRing:82, psych:86, ent:86, phys:74, overness:84 }, // Rami Sebei
  w0019: { age:44, inRing:84, psych:80, ent:76, phys:74, overness:78 }, // Fergal Devitt
  w0020: { age:41, inRing:84, psych:86, ent:88, phys:80, overness:82 }, // Kevin Steen
  w0021: { age:32, inRing:74, psych:70, ent:70, phys:80, overness:80 }, // Joseph Fatu
  w0022: { age:28, inRing:68, psych:66, ent:82, phys:66, overness:82 }, // Dominik Gutierrez
  w0023: { age:51, inRing:78, psych:88, ent:74, phys:58, overness:82 }, // Oscar Gutierrez
  w0024: { age:36, inRing:82, psych:80, ent:76, phys:72, overness:78 }, // Pamela Martinez
  w0025: { age:38, inRing:82, psych:82, ent:88, phys:78, overness:86 }, // Rebecca Quin
  w0026: { age:32, inRing:82, psych:74, ent:70, phys:78, overness:80 }, // Stephanie Vaquer
  w0027: { age:26, inRing:76, psych:70, ent:78, phys:76, overness:78 }, // Jessica Woynilko
  w0028: { age:33, inRing:66, psych:66, ent:74, phys:88, overness:76 }, // Jade Cargill
  w0029: { age:28, inRing:74, psych:66, ent:72, phys:76, overness:58 }, // Austin White
  w0030: { age:37, inRing:74, psych:66, ent:64, phys:82, overness:66 }, // Jermaine Haley
  w0031: { age:39, inRing:84, psych:74, ent:70, phys:74, overness:58 }, // Charles Betts
  w0032: { age:30, inRing:80, psych:66, ent:60, phys:74, overness:58 }, // Dragon Lee
  w0033: { age:36, inRing:70, psych:64, ent:66, phys:70, overness:57 }, // Julian Micevski
  w0034: { age:35, inRing:68, psych:62, ent:72, phys:70, overness:58 }, // Matthew Farrelly
  ...
  w0037: { age:35, inRing:74, psych:66, ent:66, phys:70, overness:57 }, // Jordan Devlin
  w0038: { age:35, inRing:74, psych:64, ent:70, phys:70, overness:59 }, // Marcel Barthel
  w0039: { age:35, inRing:72, psych:62, ent:70, phys:80, overness:60 }, // Kenneth Crawford
  w0040: { age:35, inRing:64, psych:60, ent:60, phys:74, overness:55 }, // Gary Green
  w0041: { age:28, inRing:70, psych:64, ent:66, phys:82, overness:64 }, // Oba Femi
  w0042: { age:34, inRing:62, psych:62, ent:70, phys:80, overness:57 }, // Nikola Bogojevic
  ...
  w0045: { age:40, inRing:74, psych:70, ent:66, phys:78, overness:64 }, // Miroslav Barnyashev
  w0046: { age:47, inRing:78, psych:80, ent:74, phys:78, overness:66 }, // Stephen Farrelly
  w0047: { age:28, inRing:82, psych:66, ent:66, phys:72, overness:63 }, // Tyler Bate
  w0048: { age:32, inRing:80, psych:70, ent:64, phys:80, overness:60 }, // Peter England
  w0049: { age:31, inRing:76, psych:66, ent:68, phys:72, overness:63 }, // Christian Casanova
  w0050: { age:32, inRing:86, psych:76, ent:72, phys:84, overness:64 }, // Ilja Rukober
  w0051: { age:38, inRing:80, psych:74, ent:72, phys:70, overness:61 }, // Johnny Gargano
  w0052: { age:45, inRing:68, psych:70, ent:80, phys:68, overness:61 }, // Michael Mizanin
  w0053: { age:53, inRing:58, psych:64, ent:80, phys:56, overness:59 }, // Ronnie Killings
  w0054: { age:45, inRing:80, psych:78, ent:78, phys:66, overness:70 }, // Shinsuke Nakamura
  w0055: { age:31, inRing:70, psych:62, ent:74, phys:72, overness:58 }, // Matrix Brown
  ...
  w0059: { age:34, inRing:64, psych:66, ent:78, phys:60, overness:64 }, // Alexis Kaufman
  w0060: { age:36, inRing:70, psych:60, ent:62, phys:70, overness:58 }, // Michin
  w0061: { age:41, inRing:60, psych:60, ent:66, phys:86, overness:60 }, // Savelina Fanene
  w0062: { age:35, inRing:70, psych:60, ent:60, phys:80, overness:58 }, // Kimberly Benson
  w0063: { age:34, inRing:64, psych:62, ent:78, phys:66, overness:60 }, // Chelsea Anderson
  ...
  w0070: { age:43, inRing:78, psych:70, ent:60, phys:70, overness:60 }, // Natalie Neidhart
  w0071: { age:28, inRing:74, psych:64, ent:68, phys:70, overness:60 }, // Aoife Cusack
  w0072: { age:31, inRing:56, psych:58, ent:70, phys:62, overness:52 }, // Sydney Zmrzel
  w0073: { age:24, inRing:74, psych:64, ent:70, phys:62, overness:60 }, // Carla Gonzalez
  w0074: { age:34, inRing:64, psych:60, ent:66, phys:82, overness:62 }, // Victoria Gonzalez
  w0075: { age:26, inRing:66, psych:56, ent:64, phys:74, overness:54 }, // Sol Ruca
  w0076: { age:31, inRing:64, psych:58, ent:60, phys:76, overness:56 }, // Rachel Gulotta
  w0077: { age:42, inRing:56, psych:60, ent:66, phys:58, overness:58 }, // Brianna Danielson
  w0078: { age:33, inRing:70, psych:66, ent:72, phys:56, overness:58 }, // Saraya Bevis
  ...
  w0086: { age:26, inRing:60, psych:50, ent:52, phys:74, overness:42 }, // Julius Rechsteiner
  w0087: { age:28, inRing:60, psych:50, ent:52, phys:76, overness:44 }, // Brutus Rechsteiner
  ...
  w0099: { age:40, inRing:64, psych:56, ent:60, phys:58, overness:42 }, // Candice Dawson
  w0102: { age:28, inRing:56, psych:46, ent:58, phys:74, overness:40 }, // Lash Legend

  // ================= Vanguard Pro =================
  w0103: { age:40, inRing:84, psych:88, ent:88, phys:80, overness:88 }, // Jonathan Good
  w0104: { age:32, inRing:96, psych:84, ent:82, phys:84, overness:88 }, // William Ospreay
  w0105: { age:29, inRing:82, psych:86, ent:94, phys:74, overness:88 }, // Maxwell Friedman
  w0106: { age:44, inRing:96, psych:94, ent:82, phys:78, overness:86 }, // Bryan Danielson
  w0107: { age:42, inRing:94, psych:92, ent:84, phys:74, overness:86 }, // Tyson Smith
  w0108: { age:35, inRing:88, psych:82, ent:82, phys:80, overness:84 }, // Shane Strickland
  w0109: { age:30, inRing:84, psych:82, ent:88, phys:74, overness:84 }, // Toni Rossall
  w0110: { age:33, inRing:82, psych:80, ent:82, phys:76, overness:84 }, // Mercedes Varnado
  w0111: { age:52, inRing:82, psych:90, ent:88, phys:66, overness:80 }, // Adam Copeland
  w0112: { age:34, inRing:86, psych:80, ent:76, phys:80, overness:80 }, // Stephen Woltz
  w0113: { age:55, inRing:74, psych:90, ent:88, phys:62, overness:80 }, // Chris Irvine
  w0114: { age:52, inRing:74, psych:86, ent:84, phys:64, overness:76 }, // William Reso
  w0115: { age:45, inRing:88, psych:82, ent:74, phys:90, overness:76 }, // Claudio Castagnoli
  w0116: { age:32, inRing:82, psych:78, ent:80, phys:80, overness:82 }, // Samuel Ratsch
  w0117: { age:46, inRing:82, psych:86, ent:84, phys:78, overness:78 }, // Nuufolau Seanoa
  ...
  w0121: { age:37, inRing:88, psych:70, ent:70, phys:86, overness:74 }, // Trevor Mann
  w0122: { age:37, inRing:84, psych:78, ent:76, phys:82, overness:74 }, // Adrienne Reese
  ...
  w0128: { age:34, inRing:74, psych:72, ent:78, phys:68, overness:76 }, // Brittany Baker
  w0129: { age:36, inRing:80, psych:76, ent:82, phys:70, overness:74 }, // Austin Jenkins
  w0130: { age:36, inRing:82, psych:74, ent:66, phys:72, overness:66 }, // Andrade El Idolo
  w0131: { age:31, inRing:82, psych:68, ent:66, phys:70, overness:60 }, // Luis Perales
  w0132: { age:38, inRing:70, psych:66, ent:64, phys:82, overness:58 }, // Andrew Gordy
  w0133: { age:37, inRing:76, psych:68, ent:62, phys:80, overness:58 }, // Matthew Adams
  w0134: { age:35, inRing:76, psych:70, ent:60, phys:74, overness:62 }, // Daniel Wheeler (FTR)
  w0135: { age:41, inRing:78, psych:72, ent:64, phys:72, overness:62 }, // David Harwood (FTR)
  w0136: { age:32, inRing:78, psych:66, ent:70, phys:64, overness:62 }, // Daniel Garcia
  w0137: { age:44, inRing:72, psych:84, ent:82, phys:70, overness:66 }, // Edward Moore
  ...
  w0140: { age:48, inRing:64, psych:60, ent:58, phys:82, overness:54 }, // Lance Hoyt
  w0141: { age:38, inRing:82, psych:70, ent:62, phys:76, overness:60 }, // Josh Lemay
  ...
  w0145: { age:37, inRing:66, psych:60, ent:60, phys:86, overness:56 }, // Michael Wardlow
  w0146: { age:42, inRing:80, psych:70, ent:62, phys:72, overness:62 }, // Christopher Lindsey
  ...
  w0150: { age:41, inRing:74, psych:74, ent:84, phys:66, overness:62 }, // James Cipperly
  w0151: { age:36, inRing:86, psych:74, ent:78, phys:72, overness:66 }, // Matthew Massie
  w0152: { age:31, inRing:86, psych:70, ent:76, phys:72, overness:64 }, // Nicholas Massie
  ...
  w0157: { age:34, inRing:72, psych:66, ent:66, phys:66, overness:57 }, // Dori Elizabeth Prange
  ...
  w0160: { age:39, inRing:74, psych:66, ent:70, phys:68, overness:59 }, // Melissa Cervantes
  ...
  w0163: { age:37, inRing:58, psych:56, ent:56, phys:80, overness:44 }, // Bill Morrissey
  w0164: { age:62, inRing:58, psych:60, ent:64, phys:56, overness:46 }, // Monty Sopp
  w0165: { age:49, inRing:70, psych:60, ent:70, phys:88, overness:62 }, // Franklin Lashley
  w0166: { age:41, inRing:64, psych:52, ent:56, phys:86, overness:50 }, // Brian Cage
  w0167: { age:52, inRing:56, psych:60, ent:78, phys:60, overness:52 }, // Hassan Assad
  w0168: { age:50, inRing:76, psych:60, ent:60, phys:80, overness:50 }, // Shelton Benjamin
  w0169: { age:26, inRing:66, psych:56, ent:60, phys:70, overness:52 }, // Tyler Senerchia
  w0170: { age:27, inRing:70, psych:56, ent:56, phys:72, overness:44 }, // Kevin Knight

  // ================= Crossfire Wrestling =================
  w0171: { age:41, inRing:76, psych:70, ent:74, phys:84, overness:72 }, // Quinn Ojinnaka
  w0172: { age:45, inRing:82, psych:74, ent:80, phys:70, overness:78 }, // Nicholas Nemeth
  ...
  w0177: { age:48, inRing:74, psych:72, ent:70, phys:66, overness:58 }, // Frank Gerdelman
  ...
  w0180: { age:39, inRing:82, psych:70, ent:74, phys:72, overness:58 }, // Adeel Alam
